 ...
 */
void Chart::addSeries(const CellRange &range, AbstractSheet *sheet, bool headerH, bool headerV, bool swapHeaders, QString seriesName)
{
    Q_D(Chart);
    ...
    {
        QSharedPointer<XlsxSeries> series = QSharedPointer<XlsxSeries>(new XlsxSeries(seriesName));
...
//    </c:legend>
    ...
    writer.writeStartElement(QStringLiteral("c:legend"));
        ...
        // modifica per far entrare la legenda in una sola riga
        // ---------------------------------------------------------------- //
        writer.writeEmptyElement(QStringLiteral("c:layout"));
        writer.writeStartElement(QStringLiteral("c:txPr"));
            ...
            writer.writeStartElement(QStringLiteral("a:p"));
                writer.writeStartElement(QStringLiteral("a:pPr"));
                    writer.writeStartElement(QStringLiteral("a:defRPr"));
                    writer.writeAttribute(QStringLiteral("sz"), "700");
                writer.writeEndElement();//a:pPr
                writer.writeStartElement(QStringLiteral("a:endParaRPr"));
                writer.writeAttribute(QStringLiteral("lang"), "it-IT");
            writer.writeEndElement();//a:p
...
void ChartPrivate::saveXmlSer(QXmlStreamWriter &writer, XlsxSeries *ser, int id) const
{
    ...
    // modifica per eliminare gli indicatori nel plot
    // ---------------------------------------------------------------- //
    writer.writeStartElement(QStringLiteral("c:marker"));
        writer.writeEmptyElement(QStringLiteral("c:symbol"));
        writer.writeAttribute(QStringLiteral("val"), QString("none"));
    writer.writeEndElement();//c:marker
    // ---------------------------------------------------------------- //

    // aggiunge i nomi corretti alle serie
    // ---------------------------------------------------------------- //
    bool error = false;
    error |= ser->m_seriesName=="";
    if(!error){
        writer.writeStartElement(QStringLiteral("c:tx"));
            writer.writeStartElement(QStringLiteral("c:strRef"));
                writer.writeTextElement(QStringLiteral("c:f"), ser->axDataSource_numRef.left(ser->axDataSource_numRef.indexOf(":")));
                writer.writeStartElement(QStringLiteral("c:strCache"));
                    writer.writeEmptyElement(QStringLiteral("c:ptCount"));
                    writer.writeAttribute(QStringLiteral("val"), QString("1"));
                        writer.writeStartElement(QStringLiteral("c:pt"));
                            writer.writeAttribute(QStringLiteral("idx"), QString("0"));
                            writer.writeTextElement(QStringLiteral("c:v"), QString(ser->m_seriesName));
...
void ChartPrivate::saveXmlAxisEG_AxShared(QXmlStreamWriter &writer, XlsxAxis* axis) const
{
    ...
    */
    ...
    // modifica per aggiungere la griglia solo per le ordinate
    // ---------------------------------------------------------------- //
    if(axis->axisId==1)
        writer.writeEmptyElement(QStringLiteral("c:majorGridlines")); // majorGridlines
    // ---------------------------------------------------------------- //
...
void ChartPrivate::saveXmlAxisEG_AxShared_Title(QXmlStreamWriter &writer, XlsxAxis* axis) const
{
    ...
    */
    ...
    // rimozione per eliminare gli assi
    // ---------------------------------------------------------------- //
