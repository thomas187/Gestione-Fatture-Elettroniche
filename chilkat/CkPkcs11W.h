...
// CLASS: CkPkcs11W
class CK_VISIBLE_PUBLIC CkPkcs11W  : public CkWideCharBase
{
	...
	// 
	bool InitPin(const wchar_t *pin);
	...
	// 
	bool InitToken(int slotId, const wchar_t *pin, const wchar_t *tokenLabel);
	...
	// 
	bool Login(int userType, const wchar_t *pin);
	...
	bool SetPin(const wchar_t *oldPin, const wchar_t *newPin);
