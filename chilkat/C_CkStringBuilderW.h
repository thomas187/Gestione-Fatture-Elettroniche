...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_GetHash(HCkStringBuilderW cHandle, const wchar_t *algorithm, const wchar_t *encoding, const wchar_t *charset, HCkString outStr);
CK_C_VISIBLE_PUBLIC const wchar_t *CkStringBuilderW_getHash(HCkStringBuilderW cHandle, const wchar_t *algorithm, const wchar_t *encoding, const wchar_t *charset);
...
CK_C_VISIBLE_PUBLIC BOOL CkStringBuilderW_RemoveAccents(HCkStringBuilderW cHandle);
