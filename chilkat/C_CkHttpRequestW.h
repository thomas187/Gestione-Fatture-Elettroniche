...
CK_C_VISIBLE_PUBLIC BOOL CkHttpRequestW_SaveLastError(HCkHttpRequestW cHandle, const wchar_t *path);
...
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UseGet(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UseHead(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UsePost(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UsePostMultipartForm(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UsePut(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UseUpload(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UseUploadPut(HCkHttpRequestW cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequestW_UseXmlHttp(HCkHttpRequestW cHandle, const wchar_t *xmlBody);
#endif
