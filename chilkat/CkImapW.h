...
class CK_VISIBLE_PUBLIC CkImapW  : public CkClassWithCallbacksW
{
	...
	bool Copy(unsigned long msgId, bool bUid, const wchar_t *copyToMailbox);

	// Creates an asynchronous task to call the Copy method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *CopyAsync(unsigned long msgId, bool bUid, const wchar_t *copyToMailbox);
	...
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchFlagsAsync(unsigned long msgId, bool bUid);
	...
	// represents a UID. If bUid is false, then msgId represents a sequence number.
	// The caller is responsible for deleting the object returned by this method.
	CkEmailW *FetchSingle(unsigned long msgId, bool bUid);

	// Creates an asynchronous task to call the FetchSingle method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleAsync(unsigned long msgId, bool bUid);
	...
	// AutoDownloadAttachments property is true. If bUid is true, then msgId
	// represents a UID. If bUid is false, then msgId represents a sequence number.
	const wchar_t *fetchSingleAsMime(unsigned long msgId, bool bUid);

	// Creates an asynchronous task to call the FetchSingleAsMime method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleAsMimeAsync(unsigned long msgId, bool bUid);
	...
	bool FetchSingleAsMimeSb(unsigned long msgId, bool bUid, CkStringBuilderW &sbMime);

	// Creates an asynchronous task to call the FetchSingleAsMimeSb method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleAsMimeSbAsync(unsigned long msgId, bool bUid, CkStringBuilderW &sbMime);
	...
	// email, including attachments if the AutoDownloadAttachments property is true.
	bool FetchSingleBd(unsigned long msgId, bool bUid, CkBinDataW &mimeData);

	// Creates an asynchronous task to call the FetchSingleBd method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleBdAsync(unsigned long msgId, bool bUid, CkBinDataW &mimeData);
	...
	// sequence number.
	// The caller is responsible for deleting the object returned by this method.
	CkEmailW *FetchSingleHeader(unsigned long msgId, bool bUid);

	// Creates an asynchronous task to call the FetchSingleHeader method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleHeaderAsync(unsigned long msgId, bool bUid);
	...
	// Fetches and returns the MIME of a single email header.
	const wchar_t *fetchSingleHeaderAsMime(unsigned long msgId, bool bUID);

	// Creates an asynchronous task to call the FetchSingleHeaderAsMime method with the
	// arguments provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *FetchSingleHeaderAsMimeAsync(unsigned long msgId, bool bUID);
	...
	// 
	bool SetFlag(unsigned long msgId, bool bUid, const wchar_t *flagName, int value);

	// Creates an asynchronous task to call the SetFlag method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *SetFlagAsync(unsigned long msgId, bool bUid, const wchar_t *flagName, int value);
	...
	// 
	bool StoreFlags(unsigned long msgId, bool bUid, const wchar_t *flagNames, int value);

	// Creates an asynchronous task to call the StoreFlags method with the arguments
	// provided. (Async methods are available starting in Chilkat v9.5.0.52.)
	// The caller is responsible for deleting the object returned by this method.
	CkTaskW *StoreFlagsAsync(unsigned long msgId, bool bUid, const wchar_t *flagNames, int value);
