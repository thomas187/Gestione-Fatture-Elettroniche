...
CK_C_VISIBLE_PUBLIC void CkGlobalW_getUncommonOptions(HCkGlobalW cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkGlobalW_putUncommonOptions(HCkGlobalW cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkGlobalW_uncommonOptions(HCkGlobalW cHandle);
