...
CK_C_VISIBLE_PUBLIC BOOL CkDhW_SaveLastError(HCkDhW cHandle, const wchar_t *path);
CK_C_VISIBLE_PUBLIC BOOL CkDhW_SetPG(HCkDhW cHandle, const wchar_t *p, int g);
CK_C_VISIBLE_PUBLIC BOOL CkDhW_UnlockComponent(HCkDhW cHandle, const wchar_t *unlockCode);
