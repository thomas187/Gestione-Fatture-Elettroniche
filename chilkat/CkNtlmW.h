...
class CK_VISIBLE_PUBLIC CkNtlmW  : public CkWideCharBase
{
	...
	// bit. The full set of possible flags (bit values) are shown below:NegotiateUnicode               0x00000001
	...
	// Negotiate56 0x80000000 The mapping of letters to bit values are as follows:0x01 - "A"
	// 0x02 - "B"
	// 0x04 - "C"
	// 0x10 - "D"
	// 0x20 - "E"
	...
	// 0x20000000 - "V"
	// 0x40000000 - "W"
	// 0x80000000 - "X" The default Flags value has the following flags set:
	// NegotiateUnicode, NegotiateOEM, RequestTarget, NegotiateNTLMKey,
