...
CK_C_VISIBLE_PUBLIC BOOL CkCharset_IsUnlocked(HCkCharset cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkCharset_SaveLastError(HCkCharset cHandle, const char *path);
CK_C_VISIBLE_PUBLIC void CkCharset_SetErrorBytes(HCkCharset cHandle, HCkByteData data);
CK_C_VISIBLE_PUBLIC void CkCharset_SetErrorString(HCkCharset cHandle, const char *str, const char *charset);
CK_C_VISIBLE_PUBLIC BOOL CkCharset_UnlockComponent(HCkCharset cHandle, const char *unlockCode);
