...
CK_C_VISIBLE_PUBLIC HCkTaskW CkFtp2W_GetSize64Async(HCkFtp2W cHandle, int index);
...
CK_C_VISIBLE_PUBLIC HCkTaskW CkFtp2W_GetSizeByName64Async(HCkFtp2W cHandle, const wchar_t *filename);
