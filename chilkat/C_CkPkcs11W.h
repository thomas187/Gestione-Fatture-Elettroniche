...
CK_C_VISIBLE_PUBLIC void CkPkcs11W_getSigContextPin(HCkPkcs11W cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void  CkPkcs11W_putSigContextPin(HCkPkcs11W cHandle, const wchar_t *newVal);
CK_C_VISIBLE_PUBLIC const wchar_t *CkPkcs11W_sigContextPin(HCkPkcs11W cHandle);
