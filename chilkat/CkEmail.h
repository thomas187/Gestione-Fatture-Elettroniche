...
class CK_VISIBLE_PUBLIC CkEmail  : public CkMultiByteBase
{
	...
	// method would return 0xFFFFFFFF. For example, if emails are downloaded by
	// sequence numbers via the Imap.FetchSequence method, then UIDs are not used and
	// therefore the email object will not contain this information.
	// 
	...
	// Note: Only non-multipart MIME parts are matched.
	// 
	bool GetNthBinaryPartOfTypeBd(int index, const char *contentType, bool inlineOnly, bool excludeAttachments, CkBinData &bd);
	...
	// 
	bool GetNthContentType(int index, const char *contentType, bool inlineOnly, bool excludeAttachments, CkString &outStr);
	...
	// Note: Only non-multipart content-types are matched.
	// 
	const char *getNthContentType(int index, const char *contentType, bool inlineOnly, bool excludeAttachments);
	// Returns the Content-Type of the Nth MIME sub-part matching the specified contentType.
	// The contentType can be a Content-Type such as "text/plain", or a wildcarded
	// Content-Type such as "text/*", or even just "*" to match all Content-Types. If
	// inlineOnly is true, then only MIME sub-parts having a content-disposition of
	...
	// Note: Only non-multipart content-types are matched.
	// 
	const char *nthContentType(int index, const char *contentType, bool inlineOnly, bool excludeAttachments);
