...
CK_C_VISIBLE_PUBLIC void CkDsaW_getHash(HCkDsaW cHandle, HCkByteData retval);
CK_C_VISIBLE_PUBLIC void  CkDsaW_putHash(HCkDsaW cHandle, HCkByteData newVal);
...
CK_C_VISIBLE_PUBLIC void CkDsaW_getSignature(HCkDsaW cHandle, HCkByteData retval);
CK_C_VISIBLE_PUBLIC void  CkDsaW_putSignature(HCkDsaW cHandle, HCkByteData newVal);
...
CK_C_VISIBLE_PUBLIC BOOL CkDsaW_SaveLastError(HCkDsaW cHandle, const wchar_t *path);
...
CK_C_VISIBLE_PUBLIC BOOL CkDsaW_UnlockComponent(HCkDsaW cHandle, const wchar_t *unlockCode);
