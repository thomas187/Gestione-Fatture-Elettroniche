...
CK_C_VISIBLE_PUBLIC void CkUpload_getCurrentFilename(HCkUpload cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC const char *CkUpload_currentFilename(HCkUpload cHandle);
