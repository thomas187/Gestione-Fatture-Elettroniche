...
CK_C_VISIBLE_PUBLIC void CkCacheW_getLastExpirationFetched(HCkCacheW cHandle, SYSTEMTIME * retval);
...
CK_C_VISIBLE_PUBLIC int CkCacheW_DeleteOlder(HCkCacheW cHandle, SYSTEMTIME * dateTime);
...
CK_C_VISIBLE_PUBLIC BOOL CkCacheW_GetExpiration(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME *outSysTime);
...
CK_C_VISIBLE_PUBLIC BOOL CkCacheW_SaveLastError(HCkCacheW cHandle, const wchar_t *path);
CK_C_VISIBLE_PUBLIC BOOL CkCacheW_SaveText(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME * expireDateTime, const wchar_t *eTag, const wchar_t *itemTextData);
...
CK_C_VISIBLE_PUBLIC BOOL CkCacheW_SaveToCache(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME * expireDateTime, const wchar_t *eTag, HCkByteData itemData);
...
CK_C_VISIBLE_PUBLIC BOOL CkCacheW_UpdateExpiration(HCkCacheW cHandle, const wchar_t *key, SYSTEMTIME * expireDateTime);
