...
CK_C_VISIBLE_PUBLIC BOOL CkHttpRequest_SaveLastError(HCkHttpRequest cHandle, const char *path);
...
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UseGet(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UseHead(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UsePost(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UsePostMultipartForm(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UsePut(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UseUpload(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UseUploadPut(HCkHttpRequest cHandle);
CK_C_VISIBLE_PUBLIC void CkHttpRequest_UseXmlHttp(HCkHttpRequest cHandle, const char *xmlBody);
#endif
