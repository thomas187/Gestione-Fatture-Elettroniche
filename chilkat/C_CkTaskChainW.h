...
CK_C_VISIBLE_PUBLIC void CkTaskChainW_setAbortCheck(HCkTaskChainW cHandle, BOOL (*fnAbortCheck)(void));
CK_C_VISIBLE_PUBLIC void CkTaskChainW_setPercentDone(HCkTaskChainW cHandle, BOOL (*fnPercentDone)(int pctDone));
CK_C_VISIBLE_PUBLIC void CkTaskChainW_setProgressInfo(HCkTaskChainW cHandle, void (*fnProgressInfo)(const wchar_t *name, const wchar_t *value));
CK_C_VISIBLE_PUBLIC void CkTaskChainW_setTaskCompleted(HCkTaskChainW cHandle, void (*fnTaskCompleted)(HCkTaskW hTask));
