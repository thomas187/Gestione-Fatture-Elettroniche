...
CK_C_VISIBLE_PUBLIC unsigned long CkImap_getUidNext(HCkImap cHandle);
CK_C_VISIBLE_PUBLIC unsigned long CkImap_getUidValidity(HCkImap cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_Copy(HCkImap cHandle, unsigned long msgId, BOOL bUid, const char *copyToMailbox);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_CopyAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid, const char *copyToMailbox);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchFlags(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkString outStrFlags);
CK_C_VISIBLE_PUBLIC const char *CkImap_fetchFlags(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchFlagsAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid);
...
CK_C_VISIBLE_PUBLIC HCkEmail CkImap_FetchSingle(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchSingleAsMime(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkString outStrMime);
CK_C_VISIBLE_PUBLIC const char *CkImap_fetchSingleAsMime(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleAsMimeAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchSingleAsMimeSb(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkStringBuilder sbMime);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleAsMimeSbAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkStringBuilder sbMime);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchSingleBd(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkBinData mimeData);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleBdAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid, HCkBinData mimeData);
CK_C_VISIBLE_PUBLIC HCkEmail CkImap_FetchSingleHeader(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleHeaderAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid);
CK_C_VISIBLE_PUBLIC BOOL CkImap_FetchSingleHeaderAsMime(HCkImap cHandle, unsigned long msgId, BOOL bUID, HCkString outStr);
CK_C_VISIBLE_PUBLIC const char *CkImap_fetchSingleHeaderAsMime(HCkImap cHandle, unsigned long msgId, BOOL bUID);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_FetchSingleHeaderAsMimeAsync(HCkImap cHandle, unsigned long msgId, BOOL bUID);
...
CK_C_VISIBLE_PUBLIC HCkTask CkImap_SetFlagAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid, const char *flagName, int value);
...
CK_C_VISIBLE_PUBLIC BOOL CkImap_StoreFlags(HCkImap cHandle, unsigned long msgId, BOOL bUid, const char *flagNames, int value);
CK_C_VISIBLE_PUBLIC HCkTask CkImap_StoreFlagsAsync(HCkImap cHandle, unsigned long msgId, BOOL bUid, const char *flagNames, int value);
