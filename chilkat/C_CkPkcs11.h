...
CK_C_VISIBLE_PUBLIC void CkPkcs11_getSigContextPin(HCkPkcs11 cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkPkcs11_putSigContextPin(HCkPkcs11 cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkPkcs11_sigContextPin(HCkPkcs11 cHandle);
...
CK_C_VISIBLE_PUBLIC unsigned long CkPkcs11_CreatePkcs11Object(HCkPkcs11 cHandle, HCkJsonObject attrs);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_DestroyObject(HCkPkcs11 cHandle, unsigned long hObject);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_Discover(HCkPkcs11 cHandle, BOOL onlyTokensPresent, HCkJsonObject json);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_ExportPublicKey(HCkPkcs11 cHandle, unsigned long keyHandle, HCkPublicKey pubKey);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_FindAllCerts(HCkPkcs11 cHandle);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_FindAllKeys(HCkPkcs11 cHandle, const char *keyClass, HCkJsonObject json);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_FindCert(HCkPkcs11 cHandle, const char *certPart, const char *partValue, HCkCert cert);
CK_C_VISIBLE_PUBLIC unsigned long CkPkcs11_FindObject(HCkPkcs11 cHandle, HCkJsonObject jsonTemplate);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_GenEcKey(HCkPkcs11 cHandle, HCkJsonObject publicAttrs, HCkJsonObject privateAttrs, HCkJsonObject jsonOut, HCkPublicKey pubKey);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_GenRsaKey(HCkPkcs11 cHandle, HCkJsonObject publicAttrs, HCkJsonObject privateAttrs, HCkJsonObject jsonOut, HCkPublicKey pubKey);
CK_C_VISIBLE_PUBLIC unsigned long CkPkcs11_GenSecretKey(HCkPkcs11 cHandle, const char *keyType, HCkJsonObject jsonTemplate);
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_GetCert(HCkPkcs11 cHandle, int index, HCkCert cert);
CK_C_VISIBLE_PUBLIC unsigned long CkPkcs11_ImportPrivateKey(HCkPkcs11 cHandle, HCkPrivateKey privKey, HCkJsonObject jsonTemplate);
CK_C_VISIBLE_PUBLIC unsigned long CkPkcs11_ImportSshKey(HCkPkcs11 cHandle, HCkSshKey sshKey, HCkJsonObject jsonTemplate);
...
CK_C_VISIBLE_PUBLIC BOOL CkPkcs11_QuickSession(HCkPkcs11 cHandle, int userType, const char *pin);
