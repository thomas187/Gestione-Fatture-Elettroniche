...
class CK_VISIBLE_PUBLIC CkBinDataW  : public CkWideCharBase
{
	...
	bool AppendCountedString(int numCountBytes, bool bigEndian, const wchar_t *str, const wchar_t *charset);
	...
	bool GetHash(const wchar_t *algorithm, const wchar_t *encoding, CkString &outStr);
	// Returns the hash of the contents of this object. The algorithm is the hash algorithm,
	// and can be "sha1", "sha256", "sha384", "sha512", "sha3-224", "sha3-256",
	// "sha3-384", "sha3-512", "md2", "md5", "ripemd128", "ripemd160","ripemd256", or
	// "ripemd320". The encoding can be "base64", "modBase64", "base64Url", "base32",
	...
	// "hexLower", or any of the encodings found atChilkat Binary Encodings List
	// <https://cknotes.com/chilkat-binary-encoding-list/>.
	const wchar_t *getHash(const wchar_t *algorithm, const wchar_t *encoding);
	// Returns the hash of the contents of this object. The algorithm is the hash algorithm,
	// and can be "sha1", "sha256", "sha384", "sha512", "sha3-224", "sha3-256",
	// "sha3-384", "sha3-512", "md2", "md5", "ripemd128", "ripemd160","ripemd256", or
	// "ripemd320". The encoding can be "base64", "modBase64", "base64Url", "base32",
	...
	// "hexLower", or any of the encodings found atChilkat Binary Encodings List
	// <https://cknotes.com/chilkat-binary-encoding-list/>.
	const wchar_t *hash(const wchar_t *algorithm, const wchar_t *encoding);
	...
	bool WriteAppendFile(const wchar_t *path);
