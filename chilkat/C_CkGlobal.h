...
CK_C_VISIBLE_PUBLIC void CkGlobal_getUncommonOptions(HCkGlobal cHandle, HCkString retval);
CK_C_VISIBLE_PUBLIC void CkGlobal_putUncommonOptions(HCkGlobal cHandle, const char *newVal);
CK_C_VISIBLE_PUBLIC const char *CkGlobal_uncommonOptions(HCkGlobal cHandle);
